...
export default function App() {
  return <><Header /><main id="top">
    ...
    <section className="instagram" id="instagram"><div className="wrap"><div className="section-head"><h2>Det senaste materialet</h2><p>De senaste inläggen från Instagram, rakt in på sidan.</p></div><div className="insta-frame-wrap"><iframe src="https://snapwidget.com/embed/YOUR_WIDGET_ID" title="Instagram-flöde" loading="lazy"/></div><p className="insta-note">Widgeten uppdateras automatiskt när nya inlägg publiceras.</p><a className="insta-handle" href="https://instagram.com/frokenhag" target="_blank" rel="noreferrer"><svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true"><rect x="3" y="3" width="18" height="18" rx="5" stroke="#2C5A5D" strokeWidth="1.7"/><circle cx="12" cy="12" r="4" stroke="#2C5A5D" strokeWidth="1.7"/><circle cx="17.3" cy="6.7" r="1.1" fill="#2C5A5D"/></svg>@frokenhag</a></div></section>
    <section className="contact" id="kontakt"><div className="wrap"><div className="contact-box"><h2>Har du en fråga eller feedback?</h2><p>Skicka ett DM på Instagram eller mail, så hör jag av mig så fort jag kan.</p><a className="btn btn-primary" href="mailto:hej@example.com">Skicka mail</a></div></div></section>
